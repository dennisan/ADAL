...
using MultiTenantSignIn.Utils;

namespace MultiTenantSignIn.Controllers
{
    public class TenantController : Controller
    {
        ...
        public ActionResult SignUp()
        {
            ...
            MemoryIssuerNameRegistry.CleanUpExpiredSignupTokens();
            MemoryIssuerNameRegistry.AddSignupToken(signupToken: signupToken, expirationTime: DateTimeOffset.UtcNow.AddMinutes(5));
        ...
        public ActionResult SignUpCallback()
        {
            ...
            if (MemoryIssuerNameRegistry.ContainsTenant(tenantId))
            {
                ...
                String.Equals(consent, "Granted", StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (MemoryIssuerNameRegistry.TryAddTenant(tenantId, signupToken))
                {
                    return View();
                }
            }
